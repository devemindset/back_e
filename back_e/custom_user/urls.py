...
from .views import register_user,login_user,google_auth,user_action,feed_back_view,user_info,logout_user,contact_form,update_user_view,delete_user_view,BeforeRegisterAPIView,CustomerInfoAPIView
...
urlpatterns = [
    ...
    path("contact_form/",contact_form),
     ...
     path("custom_user_info",CustomerInfoAPIView.as_view()),
